...
export default function Home() {
  ...
  return (
    <>
      <div className="bg-gradient-to-tr from-[#63298d] via-[#181f47] to-[#480776] min-h-screen  text-white  relative ">
        ...
        <div className="max-w-6xl w-screen   bg-[#36125d] flex flex-row justify-between gap-4 sm:gap-10 p-4  rounded items-center absolute top-4  lg:top-10  lg:left-44 shadow-lg ">
          <DropdownMenu>
